...
////Atm_button& Atm_button::begin(UNUSED board::DigitalPin attached_pin){
////  // clang-format off
...
////  //TODO: FASTFIX
//////  pin = gpio::FAST_PIN<attached_pin>{gpio::PinMode::INPUT_PULLUP};
////
...
////  return !pin.value();
//  return gpio::FAST_PIN<board::DigitalPin ::NONE>().value();
//}
//
